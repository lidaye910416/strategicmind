...
export type FlagName =
  ...
  | 'roundTimelineEnhance'  // P2-2/3 (RoundTimeline 趋势 + scrubber)
  // ---- P2 锦上添花（PR-3，默认 OFF）----
  | 'stageCardsSplit'       // P2-4（拆 7 个 sub-component）
  | 'dashboardSplit'        // P2-8（拆 5 个 sub-component）
  | 'compareRuns'           // P2-1
