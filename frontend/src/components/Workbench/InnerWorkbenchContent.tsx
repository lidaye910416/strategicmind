 ...
 *
 * 包含 2 列网格:
 *   - 左内列: 公司态势 + 部门 AGENT + 议题推演
 *   - 右内列: 实时知识图谱 + 涌现议题 + 智能体采访
 *   - 全宽: 信念演化 / 关系网时序 / 风险矩阵 / 图谱轮次 diff / 进一步推演
 *
...
function InnerWorkbenchContentImpl({
  ...
  return (
    <div
      ...
      className="h-full w-full overflow-y-auto nice-scroll p-3 space-y-3"
    >
      {/* ===== 2 列内层网格：公司态势/部门(左) + 实时图谱(右) ===== */}
