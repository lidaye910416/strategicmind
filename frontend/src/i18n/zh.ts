...
export const WORKBENCH = {
  ...
  // P5 pre-existing 修复 (loop-engine-v2 / T2.2 / T2.5)
  stateRunning: '运行中',
  statePaused: '暂停',
  stateCompleted: '完成',
  stateFailed: '失败',
  stateCancelled: '取消',
  stateIdle: '空闲',
  stateConfiguring: '配置中',
  idleHero: '推演工作台就绪',
  idleHeroSub: '请到首页上传种子文档并配置参数后启动推演。',
  idleHeroCta: '回到首页配置',
  pausedBanner: '推演已暂停',
  pausedBannerHint: '点继续按钮恢复推演',
  failedBanner: '推演失败',
  failedRetry: '重试推演',
  cancelledBanner: '推演已取消',
  railSectionSummary: '本轮概要',
  railSectionEmerging: '涌现实体',
  railSectionNext: '下一事件',
  railSummaryActions: '行动',
  railSummaryShifts: '漂移',
  railSummaryActive: '活跃',
  railSummaryNoData: '暂无数据',
  railEmergingEmpty: '暂无涌现实体',
  railNextEventEmpty: '暂无下一事件',
  railBtnPause: '暂停',
  railBtnPauseTitle: '暂停当前推演',
  railBtnResume: '继续',
  railBtnResumeTitle: '恢复推演',
  railBtnCancel: '取消',
  railBtnCancelTitle: '取消推演',
  railBtnAdvanceYear: '推进下一年',
  railBtnAdvanceYearTitle: '推进到下一年',
  execSummaryPlaceholderHappened: '等待推演开始…',
  execSummaryPlaceholderNext: '推演启动后将显示下一轮预测',
  execSummaryWhatHappened: (round: number) => `Round ${round} 发生了什么`,
  execSummaryWhatNext: '下一步预测',
  running: '进行中',
  done: '已完成',
  startTitle: '准备开始推演',
  ...
  // must-tier v2: 三种实时事件 banner
  marketEventTitle: '市场事件',
  marketEventBadge: '市场',
  marketEventEmpty: '暂无市场事件',
  marketEventTickerTitle: '实时市场事件流',
  marketEventTickerEmpty: '暂无市场事件流入',
  marketEventTickerHint: '每 30s 滚动一条最新市场事件',
  shockToastTitle: '外部冲击提醒',
  shockToastEmpty: '无外部冲击',
  shockToastHint: '外部冲击将自动弹出提醒',
  yearAdvancedTitle: '跨年推演完成',
  yearAdvancedSubtitle: (y: number, n: number) => `已完成第 ${y} 年推演 · 注入 ${n} 季度市场事件`,
  yearAdvancedEmpty: '尚未跨年推演',
  // must-tier v1: 三个可视化组件的 i18n 标题
  realtimeGraphTitle: '实时知识图谱',
  realtimeGraphSubtitle: '实体边构建过程实时呈现',
  beliefTitle: '信念演化',
  beliefSubtitle: '各 Agent 信念值随回合变化',
  beliefEmpty: '尚无信念数据（推演第一轮尚未完成）',
  networkTitle: '迭代关系网',
  networkSubtitle: 'Agent 间传播关系网随回合演化',
  networkEmpty: '尚无关系网数据',
  riskTitle: '风险矩阵',
  riskSubtitle: '5x5 概率-影响 热力图',
  riskEmpty: '尚无风险数据',
